...
// sssp output image
    cout << endl << "running SSSP output graph" << endl;
    ...
    cout << "SSSP visualization.png successfully saved" << endl;
...
//running force directed graph with shrinked graph
    ...
    if (myfile3.is_open()) {
        ...
        cout << "ForceDirectedGraph_Output.png successfully saved" << endl << endl;
        myfile3.close();
    }
    else cout << "Unable to open file" << endl;
